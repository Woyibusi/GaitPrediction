...
dp = data_preprocess(file_path = 'C:\\project\\STALSTM\\dataset\\combined data upto 13Nov2022_preprocessed2.csv', train_per = TRAIN_PER, vali_per = VALI_PER, in_dim = IN_DIM)
...
def main():
    ...
    torch.save(net,'C:\\project\\STALSTM\\models\\sta_lstm_TL_b2_200_combined_data_upto_13Nov2022_preprocessed2.pth')
