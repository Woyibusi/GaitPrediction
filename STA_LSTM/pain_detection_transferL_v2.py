...
if user_option =='1':
    text ='please be ready to record a pain video'
    time.sleep(1)
    train_data_pain = keypoints_extract('Pain',5)
    text ='please be ready to record a no-pain video'
    time.sleep(1)
...
#    train_data_nopain = keypoints_extract()
    ...
    torch.save(net, 'C:\\projects\\STALSTM\\models\\Du Tiehua_personalized_train.pth')
