...
net = torch.load('C:\\projects\\STALSTM\\models\\pediatric.pth')
...
dp = data_preprocess(file_path='C:\\projects\\STALSTM\\dataset\\manual combined\\pediatric.csv',
