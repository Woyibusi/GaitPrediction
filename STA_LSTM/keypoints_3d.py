...
def keypoints_extract(filename):
    ...
    keypoints = np.zeros(shape=(468,3))
    with mp_face_mesh.FaceMesh(
        ...
        while cap.isOpened():
            ...
            if results.multi_face_landmarks:
                for face_landmarks in results.multi_face_landmarks:
                    ...
                    transformed_keypoints = similarity_trans(keypoints,R,t)
        ...
        cap.release()
        return train_data
keypoints_extract("pain", 3)
#data1 = keypoints_extract("pain")
#print(data1)