...
dp = data_preprocess(file_path='C:\\projects\\STALSTM\\dataset\\manual combined\\pediatric.csv', train_per=TRAIN_PER,
...
def main():
    ...
    torch.save(net, 'C:\\projects\\STALSTM\\models\\pediatric_v1.pth')
