...
net = torch.load('C:\\projects\\STALSTM\\models\\adult_train_test_split_oct_2024.pth')
...
dp = data_preprocess(file_path='C:\\projects\\STALSTM\\dataset\\manual combined SGH_KKH\\testing_data_oct_2024.csv', train_per=TRAIN_PER,
                     vali_per=VALI_PER, in_dim=IN_DIM)
...
def main():
    ...
    torch.save(net, 'C:\\projects\\STALSTM\\models\\adult_train_test_split_oct_2024_finetune.pth')
